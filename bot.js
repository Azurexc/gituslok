...
const Settings = {
  //THIS IS IMPORTANT\\
  GUILD_ID: "1150819617376309278", // THIS IS VERY IMPORTANT, THIS IS THE ID OF YOUR SERVER, SEARCH ON YOUTUBE HOW TO GET IT IF YOU DONT KNOW HOW
  OWNER_ID: "1148969956671766710", // THIS IS VERY IMPORTANT, THIS IS THE ID OF YOUR PROFILE, SEARCH ON YOUTUBE HOW TO GET IT IF YOU DONT KNOW HOW
  Shoppy_API_KEY: "CqaVSX2bZVeMOvVKbhMOq1sMGunpkHt0q1SGPKVN8rpsxIJ1d9", // Create a Shoppy account If you haven't, then go to https://shoppy.gg/user/settings and look for your "API-KEY".
  Whitelisted_Role_ID: "1151135628105351168", // When users use the !whitelist or !rewhitelist command, they get this role.
  Blacklisted_Role_ID: "1151135728978378844", // When users who are not whitelist use the !rewhitelist command with a buyers Shoppy Order ID, they get this role.
  LogsChannel_Channel_ID: "1151136021262647378", // Create a channel for logs when a user is whtelisted or uses a command!
  //----------------\\
